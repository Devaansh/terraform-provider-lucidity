...
- `docs/index.md`, `docs/resources/`, `docs/data-sources/` — Registry docs,
  generated by `tfplugindocs generate --provider-name lucidity` from schema
  descriptions + `examples/`; re-run after any schema or examples change
