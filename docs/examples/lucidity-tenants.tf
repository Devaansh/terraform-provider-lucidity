...
#
# external_id must be a value YOU generate (a UUID works) and place in the
...
resource "lucidity_tenant" "non_prod_1" {
  ...
  cloud_entity_information {
    ...
    external_id               = "8f14e45f-ceea-4331-9f5e-111111111111"
...
resource "lucidity_tenant" "non_prod_2" {
  ...
  cloud_entity_information {
    ...
    external_id               = "8f14e45f-ceea-4331-9f5e-222222222222"
    aws_iam_role_name         = "LucidityRole"
    aws_iam_policy_name       = "LucidityPolicy"
  }
...
resource "lucidity_tenant" "non_prod_3" {
  ...
  cloud_entity_information {
    ...
    external_id               = "8f14e45f-ceea-4331-9f5e-333333333333"
    aws_iam_role_name         = "LucidityRole"
    aws_iam_policy_name       = "LucidityPolicy"
  }
...
# Organization — aws_root_id records which org root they roll up to, for
...
resource "lucidity_tenant" "qa_1" {
  display_name = "qa"
  product_list = ["AUTOSCALER"]
  aws_root_id  = "999999999999"

  cloud_entity_information {
    cloud_provider            = "AWS"
    cloud_provider_account_id = "444444444444"
    external_id               = "8f14e45f-ceea-4331-9f5e-444444444444"
    aws_iam_role_name         = "LucidityRole"
    aws_iam_policy_name       = "LucidityPolicy"
  }
...
resource "lucidity_tenant" "qa_2" {
  ...
  cloud_entity_information {
    ...
    external_id               = "8f14e45f-ceea-4331-9f5e-555555555555"
    aws_iam_role_name         = "LucidityRole"
    aws_iam_policy_name       = "LucidityPolicy"
  }
